...
enum { NetSupported, NetWMName, NetWMState, NetWMCheck,
       ...
       NetWMWindowTypeDialog, NetClientList, /* NetDesktopNames, NetDesktopViewport, NetNumberOfDesktops, NetCurrentDesktop, */ NetWMIcon, NetLast }; /* EWMH atoms */
