...
static const char *dmenucmd[]      = { "dmenu_run", "-i", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, /*"-c", "-l", "20",*/ NULL };
static const char *termcmd[]       = { "alacritty", "msg", "create-window", NULL };
static const char scratchpadname[] = "scratchpad";
static const char *scratchpadcmd[] = { "kitty", "-1", "-T", scratchpadname,/* "-g", "120x34",*/ NULL };
static const char *powermenucmd[]  = { "powermenu.sh", NULL };
static const char *alttabcmd[]     = { "dmenu-appswitcher.sh", NULL };
